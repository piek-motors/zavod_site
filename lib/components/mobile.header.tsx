    ...
    <>
      ...
      <Modal open={!!layout} onClose={() => setLayout(undefined)}>
        <ModalDialog layout={layout}>
          ...
          <DialogContent sx={{ display: "flex", flexDirection: "column", gap: 1, mt: 2 }}>
            <LinkButton href="contact-us" buttonProps={{ size: "lg", variant: "soft" }}>
              Contact us
            </LinkButton>
            <LinkButton href="sign-in" buttonProps={{ size: "lg", color: "neutral" }}>
              Sign in
            </LinkButton>
            <Divider sx={{ my: 2 }} />
