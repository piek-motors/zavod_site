...
```
**References** \
[REST API Documentation](https://toncenter.com/api/v2) \
[Client SDK Documentation](https://docs.ton.org/v3/guidelines/dapps/apis-sdks/sdk) \
[TON Blockchain Documentation](https://ton-blockchain.github.io/docs)
