...
description: Bitcoin is the first decentralized cryptocurrency, and the first blockchain-based digital currency.
---
import BtcIndexSamples from '../refs/btc_index_samples.mdx';
