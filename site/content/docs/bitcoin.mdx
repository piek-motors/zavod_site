...
JSON RPC Endpoint: https://api.chain-rpc.online/bitcoin \
...
**Refferences** \
[JSON-RPC doc](https://developer.bitcoin.org/reference/rpc/index.html)
...
API Endpoint - https://api.chain-rpc.online/bitcoin-index
